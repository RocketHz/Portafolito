...
const Header = () => {
  ...
  return (
    <header className="shadow-md shadow-oscure-primary-100">
      <nav className="bg-gradient-to-b from-light-bg-100 to-light-bg-300 dark:bg-gradient-to-b dark:from-oscure-bg-100  dark:to-oscure-bg-300">
        <div className="container flex flex-wrap items-center justify-center p-6 mx-auto text-light-text-100 capitalize dark:text-oscure-text-100">
          <a
            href="/"
            className="ocult border-b-2 mb-4 border-light-accent-200  hover:border-light-accent-100 dark:border-oscure-accent-100 hover:dark:border-oscure-accent-200 mx-1.5 sm:mx-6"
          >

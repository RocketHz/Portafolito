                    ...
                    <div className="hero-inner">
                        <div className="hero-copy">
                            ...
                            <div className="hero-cta">
                                <div className="card">
                                    <a className="social-link2" href="http://github.com/RocketHz" target="_blank" rel="noopener noreferrer">
                                        <button className="social-link1">
                                            <svg
                                    ...
                                    <a className="social-link1" href="http://www.linkedin.com/in/ronni-hernandez-a9b3301b9" target="_blank" rel="noopener noreferrer">
